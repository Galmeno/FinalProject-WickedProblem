...
This file contains my iterative breadth-first search algorithm.
'''

import sys, importlib, importlib.util
if sys.argv==[''] or len(sys.argv)<2:
#  import EightPuzzle as Problem
  spec = importlib.util.spec_from_file_location('TowersOfHanoi', 'TowersOfHanoi' + ".py")
  Problem = spec.loader.load_module()
else:
  spec = importlib.util.spec_from_file_location(sys.argv[1], sys.argv[1] + ".py")
  Problem = spec.loader.load_module()
